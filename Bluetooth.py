...
def printLogo():
    ...
    print('          ____ __ ___             __          ____________    __________________         __         ___________      _________')
    print('          |   _ _ _  \           /  \         |  _________|   |______    ______|        /  \        |   - - -  \     |        \ ')
    print('          |  |     |  |         / /\ \        |  |                   |  |              / /\ \       |  |     |  |    |   ___   \ ')
    print('          |   - - -  /         / /  \ \       |  |                   |  |             / /  \ \      |   - - -   /    |  |   \   \ ')
    print('          |       ---         / /____\ \      |  |________           |  |            / /____\ \     |  ____   _/     |  |    \  |')
    print('          |   _ _ _  \       /  ______  \     |_________  |          |  |           / _______  \    |  |   \  \      |  |    /  / ')
    print('          |  |     |  |     / /        \ \             |  |          |  |          / /        \ \   |  |    \  \     |  |___/  /')
    print('          |   - - -   /    / /          \ \    ________|  |          |  |         / /          \ \  |  |     \  \    |        /')
    print('          |___ __ ___/    /_/            \_\  |___________|          |__|        /_/            \_\ |__|      \__\   |_______/')
    print('          \n        Samrat Samrat Samrat Samrat Samrat Samrat Samrat Samrat Samrat Samrat Samrat Samrat Samrat Samrat Samrat Samrat Samrat')
def main():
    printLogo()
    time.sleep(0.1)
